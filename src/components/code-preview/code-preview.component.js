 ...
 * @slot Code - Code preview panel.
 * @slot CSS - CSS source code.
 * @slot JS - JavaScript source code.
 * @slot React - React source code.
 * @slot Vue - Vue source code.
 *
...
export default class CodePreview extends LitElement {
    ...
    _handleResizerDrag(event) {
        ...
        console.log(event.target.localName, { resizer }, this)
    ...
    connectedCallback() {
        ...
        // document.addEventListener("mousedown", this._handleResizerDrag)
        // document.addEventListener("touchstart", this._handleResizerDrag, { passive: true })
    }

    disconnectedCallback() {
        document.removeEventListener("mousedown", this._handleResizerDrag)
        document.removeEventListener("touchstart", this._handleResizerDrag)
    }
    ...
    render() {
        return html`
            ...
            >
                ...
                <div class="code-preview__resizer" @click=${this._handleResizerDrag}>
                ...
                <div
                    class="code-preview__source code-preview__source--html"
                    data-flavor="html"
                >
                    <pre>
                ...
                <div
                    class="code-preview__source code-preview__source--react"
                    data-flavor="react"
                >
                    <pre>
                ...
                <div class="code-preview__buttons">
                    ...
                    <button
                        ...
                        class="code-preview__button code-preview__button--html code-preview__button--selected"
                        data-flavor-trigger="html"
                    >
                        HTML
                    </button>
                    ...
                    <button
                        ...
                        class="code-preview__button code-preview__button--react"
                        data-flavor-trigger="react"
                    >
                        React
                    </button>
                    ...
                    <button
                        type="button"
                        title="Show Vue code"
                        class="code-preview__button code-preview__button--vue"
                        data-flavor-trigger="vue"
                    >
                        Vue
                    </button>
